...
# bitbridge runtime library version
BITBRIDGE_LIB_VER := 0.1.0
...
BITBRIDGE_LIB_DESC := Bitbridge runtime library
VENDOR_COPYRIGHT   := Copyright (C) 2008-2017 $(VENDOR_NAME), $(VENDOR_URL)

# licence for generated pkgconfig .pc file
BITBRIDGE_LIB_LICENCE := LGPL version 3 or any later version
